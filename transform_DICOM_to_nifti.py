...
if __name__ == "__main__":
    file_mapping = {}
    inference_path = r"D:\nnUNet_raw\Dataset117_Spine\imagesTr"
    for i, folder in enumerate(os.listdir(inference_path)):
        nifti_renamer(os.path.join(inference_path,folder), prefix='Spi_', suffix='_0000', number=i, file_mapping=file_mapping)
    json_path = os.path.join(Path(inference_path).parent, 'decoder_volumes.json')
